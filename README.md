...
**Name:** Ella Pearl V. Cadungog  
**Assigned Gene:** GALT (Galactose-1-phosphate uridylyltransferase)  
...
Classic galactosemia is an inherited metabolic disorder caused by deficient activity of the galactose-1-phosphate uridylyltransferase (GALT) enzyme. GALT is essential for the normal metabolism of galactose. Impaired GALT activity disrupts galactose processing and causes the accumulation of galactose and its metabolites in the body.

Affected newborns commonly present with poor feeding, vomiting, diarrhea, failure to thrive, and jaundice. Cataract formation and an increased risk of *Escherichia coli* sepsis may also occur during infancy. Long-term complications may include developmental delay, speech difficulties, neurological abnormalities, and reproductive problems.
